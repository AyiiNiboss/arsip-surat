          ...
          <div class="card-body">
            ...
            <div class="row g-2 mb-1">
                <div class="col-6 mb-3">
                  ...
                  <input type="text" id="catatan" name="aktivitas" value="{{ $data->aktivitas == 3 ? 'Ajukan Ke Kepala' : 'Koreksi Kembali' }}" class="form-control" placeholder="Silahkan beri catatan disini" readonly />
                </div>
