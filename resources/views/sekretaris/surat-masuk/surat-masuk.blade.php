          ...
          <table class="table table-hover">
            ...
            <tbody class="table-border-bottom-0">
              ...
              <tr>
                  ...
                  <td class="text-center">
                    @if ($row->aktivitas == 3 || $row->aktivitas == 2)
                        <a href="/sm-sekretaris-detail/{{ $row->id }}" class="btn btn-icon btn-success" title="Detail"><span class="bx bx-show-alt me-1"></span></a>
                    @endif
                    @if($row->aktivitas == 1)
                        <a href="/sm-sekretaris-ajukan/{{ $row->id }}" class="btn btn-icon btn-warning" title="Ajukan"><span class="bx bx-paper-plane me-1"></span></a>
                    @endif
                    @if ($row->aktivitas == 4 )
