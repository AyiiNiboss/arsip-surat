...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Arsip / Surat Masuk /</span> Detail Surat Masuk</h4>
    <div class="row">
      <div class="col-md-12">
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <a href="/surat-masuk-arsip" class="btn btn-info">Kembali</a>
          </div>
        </div>
      </div>
    </div>
