        ...
        <div class="row">
            <div class="col">
                <h5 class="text-center my-3">
                    ...
                    Rekapan Data Arsip Surat Keluar
                    @else
                    Rekapan Data Arsip Surat Keluar dari tanggal {{ Carbon\Carbon::parse($tanggal_a)->translatedFormat('d F Y'); }} - {{ Carbon\Carbon::parse($tanggal_b)->translatedFormat('d F Y'); }}
                    @endif
                </h5>
    ...
    <table class="table table-borderless" style="margin-left: 50px;">
        <thead>
            <tr>
                ...
                <th style="width: 40%">Palembang, 12 Juni 2023</th>
              </tr>
        </thead>
        <thead>
            <tr>
              ...
              <br><br><br><br>
            <tr>
                <th style="text-align: left">Jeden Smith</th>
                <th style="width: 40%">Arman Sarijaya, S.H</th>
              </tr>
        </thead>
    </table>
    </div>
