        ...
        <div class="row">
            <div class="col">
                <h5 class="text-center my-3">
                    ...
                    Rekapan Data Arsip Surat Masuk
                    @else
                    Rekapan Data Arsip Surat Masuk dari tanggal {{ Carbon\Carbon::parse($tanggal_a)->translatedFormat('d F Y'); }} - {{ Carbon\Carbon::parse($tanggal_b)->translatedFormat('d F Y'); }}
                    @endif
                </h5>
