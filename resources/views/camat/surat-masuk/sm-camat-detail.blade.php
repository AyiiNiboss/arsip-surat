          ...
          <div class="card-body">
            ...
            <div class="row g-2 mb-1">
                <div class="col-6 mb-3">
                  <label for="dobBasic" class="form-label">disposisi ke</label>
                  <input type="text" id="catatan" name="disposisi" value="{{ $data->bagianRelasi->nama_bagian }}" class="form-control" placeholder="Silahkan beri catatan disini" readonly />
                </div>
                <div class="col-6 mb-3">
                  <label for="dobBasic" class="form-label">Tanggal disposisi</label>
                  <input type="text" id="catatan" name="aktivitas" value="{{ Carbon\Carbon::parse($data->tgl_disposisi)->translatedFormat('d F Y'); }}" class="form-control" placeholder="Silahkan beri catatan disini" readonly />
                </div>
                <div class="col-6 mb-3">
                  <label for="dobBasic" class="form-label">Catatan</label>
                  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" readonly>{{ $data->catatan_camat }}</textarea>
                </div>
              </div>
