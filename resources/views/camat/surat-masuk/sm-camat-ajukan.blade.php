      ...
      <div class="col-md-12">
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <form action="/sm-camat-ajukan-proses/{{ $data->id }}" method="POST" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <div class="row g-2 mb-3">
                <div class="col-6 mb-3">
                    <label for="dobBasic" class="form-label">Disposisi ke</label>
                    <select class="form-select" name="disposisi" id="exampleFormControlSelect1" aria-label="Default select example">
                ...
                <div class="col-6 mb-0" id="catatanInputDiv">
                  <label for="catatan" class="form-label">Tanggal disposisi</label>
                  <input type="date" id="catatan" name="tgl_disposisi" class="form-control" placeholder="Silahkan beri catatan disini" required />
                </div>
                <div class="col-12 mb-0" id="catatanInputDiv">
                  <label for="catatan" class="form-label">Catatan</label>
                  <textarea class="form-control" name="catatan_camat" id="exampleFormControlTextarea1" rows="3"></textarea>
                </div>
              </div>
              <div class="col-6">
